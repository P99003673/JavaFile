...
public PlayerExam(String name, Date dateOfBirth, String skill, int numberOfMatches, int runs, int wickets,
...
public PlayerExam(String name2, String string, String skill2, String string2, String string3, String string4,
...
public static PlayerExam createPlayer(String detail) throws ParseException {
	String[] st=detail.split(",");
	PlayerExam P=new PlayerExam(st[0],st[1],st[2],st[3],st[4],st[5],st[6],st[7]);
	return P;
